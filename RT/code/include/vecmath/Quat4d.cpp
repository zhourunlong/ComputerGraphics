...
// static
inline const Quat4d Quat4d::ZERO = Quat4d( 0, 0, 0, 0 );

// static
inline const Quat4d Quat4d::IDENTITY = Quat4d( 1, 0, 0, 0 );

inline Quat4d::Quat4d()
{
	m_elements[ 0 ] = 0;
	m_elements[ 1 ] = 0;
	m_elements[ 2 ] = 0;
...
inline Quat4d::Quat4d( double w, double x, double y, double z )
{
	m_elements[ 0 ] = w;
	m_elements[ 1 ] = x;
	m_elements[ 2 ] = y;
...
inline Quat4d::Quat4d( const Quat4d& rq )
{
...
inline Quat4d& Quat4d::operator = ( const Quat4d& rq )
{
	if( this != ( &rq ) )
	{
		m_elements[ 0 ] = rq.m_elements[ 0 ];
...
inline Quat4d::Quat4d( const Vector3d& v )
{
	m_elements[ 0 ] = 0;
	m_elements[ 1 ] = v[ 0 ];
	m_elements[ 2 ] = v[ 1 ];
...
inline Quat4d::Quat4d( const Vector4d& v )
{
	m_elements[ 0 ] = v[ 0 ];
	m_elements[ 1 ] = v[ 1 ];
	m_elements[ 2 ] = v[ 2 ];
...
inline const double& Quat4d::operator [] ( int i ) const
{
	return m_elements[ i ];
}

inline double& Quat4d::operator [] ( int i )
{
	return m_elements[ i ];
}

inline double Quat4d::w() const
{
	return m_elements[ 0 ];
}

inline double Quat4d::x() const
{
	return m_elements[ 1 ];
}

inline double Quat4d::y() const
{
	return m_elements[ 2 ];
}

inline double Quat4d::z() const
{
	return m_elements[ 3 ];
}

inline Vector3d Quat4d::xyz() const
{
	return Vector3d
	(
		m_elements[ 1 ],
...
inline Vector4d Quat4d::wxyz() const
{
	return Vector4d
	(
		m_elements[ 0 ],
...
inline double Quat4d::abs() const
{
	return sqrt( absSquared() );	
}

inline double Quat4d::absSquared() const
{
	return
	(
...
inline Quat4d Quat4d::normalized() const
{
	Quat4d q( *this );
	q.normalize();
	return q;
...
inline Quat4d Quat4d::conjugated() const
{
	return Quat4d
	(
		 m_elements[ 0 ],
...
inline Quat4d Quat4d::inverse() const
{
	return conjugated() * ( 1.0f / absSquared() );
}


inline Quat4d Quat4d::log() const
{
	double len =
		sqrt
		(
...
inline Quat4d Quat4d::exp() const
{
	double theta =
		sqrt
		(
...
inline Vector3d Quat4d::getAxisAngle( double* radiansOut )
{
...
inline void Quat4d::setAxisAngle( double radians, const Vector3d& axis )
{
...
inline void Quat4d::print()
{
	printf( "< %.4lf + %.4lf i + %.4lf j + %.4lf k >\n",
		m_elements[ 0 ], m_elements[ 1 ], m_elements[ 2 ], m_elements[ 3 ] );
}

// static
inline double Quat4d::dot( const Quat4d& q0, const Quat4d& q1 )
{
	return
	(
		q0.w() * q1.w() +
...
// static
inline Quat4d Quat4d::lerp( const Quat4d& q0, const Quat4d& q1, double alpha )
{
	return( ( q0 + alpha * ( q1 - q0 ) ).normalized() );
}

// static
inline Quat4d Quat4d::slerp( const Quat4d& a, const Quat4d& b, double t, bool allowFlip )
{
...
// static
inline Quat4d Quat4d::squad( const Quat4d& a, const Quat4d& tanA, const Quat4d& tanB, const Quat4d& b, double t )
{
...
// static
inline Quat4d Quat4d::cubicInterpolate( const Quat4d& q0, const Quat4d& q1, const Quat4d& q2, const Quat4d& q3, double t )
{
...
// static
inline Quat4d Quat4d::logDifference( const Quat4d& a, const Quat4d& b )
{
...
// static
inline Quat4d Quat4d::squadTangent( const Quat4d& before, const Quat4d& center, const Quat4d& after )
{
...
// static
inline Quat4d Quat4d::fromRotationMatrix( const Matrix3d& m )
{
	double x;
	double y;
	double z;
...
// static
inline Quat4d Quat4d::fromRotatedBasis( const Vector3d& x, const Vector3d& y, const Vector3d& z )
{
	return fromRotationMatrix( Matrix3d( x, y, z ) );
}

// static
inline Quat4d Quat4d::randomRotation( double u0, double u1, double u2 )
{
	double z = u0;
...
inline Quat4d operator + ( const Quat4d& q0, const Quat4d& q1 )
{
	return Quat4d
	(
		q0.w() + q1.w(),
...
inline Quat4d operator * ( double f, const Quat4d& q )
{
	return Quat4d
	(
		f * q.w(),
...
inline Quat4d operator * ( const Quat4d& q, double f )
{
	return Quat4d
	(
		f * q.w(),
